...
public class ClienteServicio {
	...
	public void listarClientes() {
		...
		clientUno.setAniosCliente("7 años");
		...
		clientDos.setAniosCliente("1 día");
		...
		this.listaClientes.stream().forEach(
			...
			System.out.println("Años como Cliente: " + listaFinal.getAniosCliente());
			System.out.println("Categoría del Cliente: " + listaFinal.getNombreCategoria());
			System.out.println("\n------------------------------------");
		}
);
	}
